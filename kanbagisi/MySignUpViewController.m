...
- (void)viewDidLoad {
    ...
    [self.signUpView.usernameField setPlaceholder:@"Kullanıcı Adı"];
    [self.signUpView.passwordField setPlaceholder:@"Şifre"];
    [self.signUpView.emailField setPlaceholder:@"e-posta"];
    [self.signUpView.additionalField setPlaceholder:@"Telefon"];
...
- (void)viewDidLayoutSubviews {
    ...
    [self.signUpView.dismissButton setFrame:CGRectMake(10.0f, 14.0f, 87.5f, 45.5f)];
