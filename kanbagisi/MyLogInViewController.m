...
- (void)viewDidLoad {
    ...
    [self.logInView.logInButton setTitle:@"Giriş" forState:UIControlStateNormal];
    [self.logInView.logInButton setTitle:@"Giriş" forState:UIControlStateHighlighted];
    ...
    [self.logInView.usernameField setPlaceholder:@"Kullanıcı Adı"];
    [self.logInView.passwordField setPlaceholder:@"Şifre"];
...
- (void)viewDidLayoutSubviews {
    ...
    [self.logInView.dismissButton setFrame:CGRectMake(10.0f, 14.0f, 87.5f, 45.5f)];
